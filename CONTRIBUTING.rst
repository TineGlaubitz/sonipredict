...
----------------------------------
1. Check that you have the latest version of :code:`sonipredict`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/TineGlaubitz/sonipredict/issues
...
1. Get the code. Fork the repository from GitHub using the big green button in the top-right corner of
   https://github.com/TineGlaubitz/sonipredict
2. Clone your directory with

.. code-block:: sh

    $ git clone https://github.com/<YourUsername>/sonipredict
...
If you spend a while working on your changes, further commits may be made to the main :code:`sonipredict`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/TineGlaubitz/sonipredict
