...
project = "sonipredict"
copyright = f"{date.today().year}, Christina Glaubitz"
...
modindex_common_prefix = ["sonipredict."]
...
# of the sidebar.
#
if os.path.exists("figs/logo.png"):
    html_logo = "figs/logo.png"

# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "sonipredictdoc"
